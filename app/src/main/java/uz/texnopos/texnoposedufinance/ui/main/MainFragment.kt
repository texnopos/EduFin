...
import uz.texnopos.texnoposedufinance.ui.main.group.info.GroupInfoFragment
import uz.texnopos.texnoposedufinance.ui.main.group.info.GroupInfoFragmentArgs
            ...
            when (childNavController.currentDestination?.id) {
                ...
                R.id.nav_group_info -> {
                    if (::groupId.isInitialized) {
                        val action = MainFragmentDirections.actionMainFragmentToAddStudentFragment(groupId)
                        navController.navigate(action)
                    }
